...
#Training set is every year other than 2016
trainingSet <- filter(dataSet, year_number != "2016")
#Testing set is data from 2016 only
testingSet <- filter(dataSet, year_number == "2016")
```
