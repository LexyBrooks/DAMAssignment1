...
# Let's also create a column for the month number and another one for year number and another column for TIME, a unique number to summarise the month and year
